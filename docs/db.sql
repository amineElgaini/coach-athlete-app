...
(1, '2024-12-17', '09:00:00', '11:00:00', TRUE),
(1, '2024-12-17', '14:00:00', '16:00:00', TRUE),
(1, '2024-12-18', '10:00:00', '12:00:00', TRUE),
(1, '2024-12-19', '09:00:00', '11:00:00', TRUE),
(1, '2024-12-20', '15:00:00', '17:00:00', TRUE),

-- Sarah Johnson availabilities
(2, '2024-12-17', '08:00:00', '10:00:00', TRUE),
(2, '2024-12-17', '11:00:00', '13:00:00', TRUE),
(2, '2024-12-18', '08:00:00', '10:00:00', TRUE),
(2, '2024-12-19', '14:00:00', '16:00:00', TRUE),
(2, '2024-12-20', '09:00:00', '11:00:00', TRUE),

-- Michael Brown availabilities
(3, '2024-12-17', '10:00:00', '12:00:00', TRUE),
(3, '2024-12-17', '16:00:00', '18:00:00', TRUE),
(3, '2024-12-18', '10:00:00', '12:00:00', TRUE),
(3, '2024-12-19', '16:00:00', '18:00:00', TRUE),
(3, '2024-12-20', '10:00:00', '12:00:00', TRUE),

-- Emma Davis availabilities
(4, '2024-12-17', '09:00:00', '11:00:00', TRUE),
(4, '2024-12-18', '09:00:00', '11:00:00', TRUE),
(4, '2024-12-18', '14:00:00', '16:00:00', TRUE),
(4, '2024-12-19', '10:00:00', '12:00:00', TRUE),
(4, '2024-12-20', '14:00:00', '16:00:00', TRUE),

-- David Wilson availabilities
(5, '2024-12-17', '07:00:00', '09:00:00', TRUE),
(5, '2024-12-17', '18:00:00', '20:00:00', TRUE),
(5, '2024-12-18', '07:00:00', '09:00:00', TRUE),
(5, '2024-12-19', '18:00:00', '20:00:00', TRUE),
(5, '2024-12-20', '07:00:00', '09:00:00', TRUE);

-- Insert bookings
INSERT INTO bookings (athlete_id, coach_id, availability_id, booking_date, start_time, end_time, status) VALUES
-- Accepted bookings
(6, 1, 1, '2024-12-17', '09:00:00', '10:00:00', 'accepted'),
(7, 2, 6, '2024-12-17', '08:00:00', '09:00:00', 'accepted'),
(8, 3, 11, '2024-12-17', '10:00:00', '11:00:00', 'accepted'),

-- Pending bookings
(9, 4, 16, '2024-12-17', '09:00:00', '10:00:00', 'pending'),
(10, 5, 21, '2024-12-17', '07:00:00', '08:00:00', 'pending'),
(11, 1, 3, '2024-12-18', '10:00:00', '11:00:00', 'pending'),

-- Past accepted bookings (for reviews)
(6, 2, NULL, '2024-12-15', '08:00:00', '09:00:00', 'accepted'),
(7, 3, NULL, '2024-12-14', '16:00:00', '17:00:00', 'accepted'),
(8, 1, NULL, '2024-12-13', '14:00:00', '15:00:00', 'accepted'),
(9, 5, NULL, '2024-12-12', '18:00:00', '19:00:00', 'accepted'),

-- Cancelled booking
(12, 4, NULL, '2024-12-16', '14:00:00', '15:00:00', 'cancelled'),

-- Rejected booking
(11, 2, NULL, '2024-12-16', '11:00:00', '12:00:00', 'rejected');
